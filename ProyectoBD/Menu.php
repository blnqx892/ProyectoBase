<nav class="navbar navbar-default top-navbar" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand waves-effect waves-dark" href=""><i
                class="large material-icons">track_changes</i> <strong>Proyecto_BD</strong></a>
...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            <li>
                <a href="RegistraAlumnoRO.php" class="waves-effect waves-dark"><i class="fa fa-perm_identity"></i>
                    Registrar RO</a>
            </li>
            <li>
                <a href="RegistraAlumnoSE.php" class="waves-effect waves-dark"><i class="fa fa-perm_identity"></i>
                    Registrar SE</a>
            </li>
            <li>
                <a href="RegistraAlumnoRC.php" class="waves-effect waves-dark"><i class="fa fa-perm_identity"></i>
                    Registrar RC</a>
            </li>
        </ul>
