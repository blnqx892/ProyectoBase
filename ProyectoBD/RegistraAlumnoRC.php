...
<head>
    ...
    <title>RC-Registrar Alumno</title>
        ...
        <div id="page-wrapper">
            <div class="header">
                <h1 class="page-header">
                    Registrar Alumno READ COMMIT<small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#">Inicio</a></li>
                    <li><a href="#">Registrar Alumno READ COMMIT</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form class="col s12" action="RegistraAlumnoRC.php" method="post" id="frmfin"
                                    name="frmfin">
