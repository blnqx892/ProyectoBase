...
<head>
    ...
    <title>RO-Registrar Alumno</title>
        ...
        <div id="page-wrapper">
            <div class="header">
                <h1 class="page-header">
                    Registrar Alumno READ ONLY<small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#">Inicio</a></li>
                    <li><a href="#">Registrar Alumno READ ONLY</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <form class="col s12" action="RegistraAlumnoRO.php" method="post" id="frmfin"
                                    name="frmfin">
                                    ...
                                    <div class="card-content">
                                        <button class="waves-effect waves-light btn" type="button" id="enviar"
                                            name="enviar" class="btn btn-success" value=""
...
if ($bandera=="add") {
    try{
        ...
        $a->beginTransaction();
        $a->exec("set transaction isolation level read only");
       ...
       //echo "alertaExito();".$ex->getMessage()."');"; 
        echo "location.href='RegistraAlumnoRO.php';";
        echo "</script>";
